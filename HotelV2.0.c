...
//incluir header no programa final
...
/*void addInfoHospede(int z[1], int w[1]){
    ...
    prinf("Você deseja adicionar um hospede? (1) SIM (2) NAO\n");
    scanf("%d", &escolha);
    if (escolha == 1) break;
...
/*void infoHospedes(){
    //acessar informações do hospede por apartamento
}*/
